<template>
  <div class="w-full flex flex-col bg-white">
    ...
    <Menu />
    <!-- Splash text -->
    <div class="w-full mt-24 md:mt-0 home bg-cover md:h-1080 md:overflow-hidden">
      <div class="md:py-300p py-10 w-full max-w-container flex justify-center mx-auto">
        <div class="md:text-7xl text-3xl font-semibold">
          ...
          <div class="text-white" id="service-mobile">af alle mærker</div>
          <div class="text-white text-xl md:text-4xl uppercase pt-4 italic">- 20 års erfaring</div>
        </div>
      </div>
    </div>
    ...
    <div class="block md:hidden py-6 w-full">
      ...
      <div class="py-4 px-4">
        E. Johansens Autoelektro er din specialiserede mekaniker i Grindsted og omegn. Her får du fuld service og diagnose af bilens elektronik med avanceret testudstyr. Vi fixer også ethvert mekanisk problem – selv de lidt mere komplicerede af slagsen.
      </div>
      <div class="py-4 px-4">
        <div v-for="(item, index) in services" :key="item" :id="index === services.length -2 ? 'contact-mobile' : 'a'+index">
    ...
    >
      <div class="w-full items-center justify-center px-6">
        <div class="bg-white p-6 w-full my-8">
          ...
          <div class="mb-2 mt-2">
            Hvis du ønsker at vide en pris på opgaven på din bil, så kontakt Flemming allerede i dag, og få et uforpligtende tilbud. Du kan bestille tid på telefon <a class="text-blue-700" href="tel:+4575320566">75320566</a> eller udfyld kontaktformularen.
          </div>
          <div class="w-full">
            <div class>
              ...
              <div class="w-full flex justify-end">
                <button class="px-4 py-2 bg-blue-600 text-white mt-4 hover:bg-blue-400">Send</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="w-full flex flex-col items-center pt-20p pb-40p md:hidden">
      ...
      <div class="pt-3 px-4 w-full">
        Hvis du er på udkig efter en mekaniker med erfaring, og ønsker at din bil er i trygge hænder, så kig forbi E. Johansens Autoelektro i Grindsted.<br /> 
        Indehaveren af E. Johansens Autoelektro, Flemming Kristensen, har mere end 40 års erfaring som mekaniker. <br /> Han udfører alle typer opgaver – uanset bilmærke. Få fixet din bil hos E. Johansens Autoelektro og bliv godt kørende med en kvalitetsbevidst og professionel service af din bil. 
      </div>
      <div class="pt-2">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10680.076639074025!2d8.971584964698524!3d55.75486211407749!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2db25eb9fc047884!2sE.%20Johansens%20Autoelektro%20v%2FFlemming%20Kristensen!5e0!3m2!1sen!2ses!4v1575067667119!5m2!1sen!2ses" width="320" height="300" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
      </div>
    </div>
    ...
    >
      <div class="w-full flex justify-center image-zoom-container">
        ...
        <div class="h-300p w-300p img-hover-zoom--quick-zoom overflow-hidden">
          <img
            src="https://res.cloudinary.com/dv6mzgcxx/image/upload/c_fit,h_300,q_65,w_300/v1573933638/frontcar.d8b8d784_nbfhyn.png"
            class="w-300p h-300p"
          />
        </div>
        <div
      ...
      <div class="w-full flex justify-center image-zoom-container">
        ...
        <div class="h-300p w-300p img-hover-zoom--quick-zoom overflow-hidden">
          <img src="../assets/hands.png" class="w-300p h-300p" />
        </div>
      </div>
    </div>
    <!-- Kontakt desktop -->
    ...
    >
      <div class="max-w-container flex flex-col mx-auto w-full items-center justify-center">
        ...
        >
          ...
          <div
            class="mb-10 mt-6"
          >Hvis du ønsker at vide en pris på opgaven på din bil, så kontakt Flemming allerede i dag, og få et uforpligtende tilbud. Du kan bestille tid på telefon <a class="text-blue-700" href="tel:+4575320566">75320566</a> eller udfyld kontaktformularen.</div>
          <div class="w-full">
            <div class>
    ...
    <div class="w-full md:flex flex-col items-center py-40p hidden">
      ...
      <div class="pt-2">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10680.076639074025!2d8.971584964698524!3d55.75486211407749!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2db25eb9fc047884!2sE.%20Johansens%20Autoelektro%20v%2FFlemming%20Kristensen!5e0!3m2!1sen!2ses!4v1575067667119!5m2!1sen!2ses" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
      </div>
    </div>
...
<!-- Footer mobile -->
      <div class="w-full flex justify-between py-2 px-4 bg-gray-900 md:hidden text-white">
            ...
            <div>
                <i class="fas fa-phone-alt mr-3"></i><a href="tel:+4575320566">75 32 05 66</a>
            </div>
        </div>
...
<!-- Footer desktop -->
          ...
          <div class="w-full hidden  md:flex flex-col py-2 px-4 bg-gray-800 text-white py-6">
            ...
            <div class="w-1100p mx-auto">
              Heimdalsvej 22, 7200 Grindsted, Denmark
            </div>
        </div>
  </div>
</template>
...
.home {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
    url("https://res.cloudinary.com/dv6mzgcxx/image/upload/w_1920,ar_16:9,c_fill,g_auto,e_sharpen/v1573933642/car-service.8c32b1d9_e35frt.jpg");
...
.services {
  ...
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
    url("https://res.cloudinary.com/dv6mzgcxx/image/upload/c_fit,h_1080,w_1920/v1573935364/engine_va4amn.jpg");
  background-repeat: no-repeat;
